    ...
    const initializeAuth = async () => {
      try {
        ...
        if (keycloak.authenticated && keycloak.tokenParsed) {
          ...
          // Setup API client
          console.log('🔧 AuthContext: Setting Keycloak to API client');
          console.log('🔐 Keycloak instance details:', {
            authenticated: keycloak.authenticated,
            tokenExists: !!keycloak.token,
            tokenParsedExists: !!keycloak.tokenParsed,
          ...
          console.log('✅ AuthContext: Keycloak set to API client successfully');
