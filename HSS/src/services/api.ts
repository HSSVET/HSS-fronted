...
export class ApiClient {
  ...
  setKeycloak(keycloak: any) {
    console.log('🔧 API Client: Setting Keycloak instance:', {
  ...
  private async getHeaders(): Promise<HeadersInit> {
    ...
    console.log('🔍 API Client - Keycloak check:', {
      keycloakExists: !!this.keycloak,
      authenticated: this.keycloak?.authenticated,
      tokenExists: !!this.keycloak?.token,
      tokenParsedExists: !!this.keycloak?.tokenParsed
    });
    ...
    if (this.keycloak?.authenticated) {
      ...
      console.log('❌ Keycloak not authenticated or missing');
    }
  ...
  async get<T>(endpoint: string): Promise<T> {
    console.log('🚀 API Client GET called for endpoint:', endpoint);
